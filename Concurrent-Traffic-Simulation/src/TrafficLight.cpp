...
void TrafficLight::waitForGreen()
{
    ...
    while ( true ) {
        ...
        if ( lightPhaseMessage == TrafficLightPhase::green ) return ;
    }
}
...
void TrafficLight::cycleThroughPhases()
{
    ...
    // random number  between 4000 to 6000
    std::default_random_engine generator ;
    std::uniform_real_distribution<double> distribution( 4000.0, 6000.0 ) ;
    
    // one cycle duration 
    double cycDur = distribution( generator ) ;

    // istart the chronometer
